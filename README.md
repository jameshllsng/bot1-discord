...
- Registro automático de mensagens apagadas: Toda vez que uma mensagem é deletada, um log completo e detalhado é enviado para um canal de auditoria e para o canal original.
- Monitoramento de mensagens editadas: Armazena e apresenta o histórico antes e depois de edições importantes em canais do servidor.
- Utilização de Embeds do Discord: Todas as notificações são formatadas em embeds para garantir clareza, leitura rápida e uma apresentação visual profissional.
